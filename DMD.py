...
##### plotting functions 
    ...
    def get_PSI(self, fband, labels = []):
        ...
        PSI = _get_data(self, fband, 'PSI', labels)
       
        return(PSI)
    
    def get_AMP(self, fband, labels = []):
        '''
        ...
        AMP: dataframe 
            ...
            in fbands and labels
        '''         
        AMP = _get_data(self, fband, 'AMP', labels)
...
##**************************************           ********************************************
    def _scale_input(self):
        """
        function to sclae input to DMD based on definition in class 
        centre: zero mean 
...
def _get_data(self, fband, mode, labels = []):
    '''
    Parameters
    ----------
    fbands: list, shape [[a,b],[c,d]]
